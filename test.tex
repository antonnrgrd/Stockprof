...
\begin{axis}[
        ...
        ymax=120,  %max = max observed y value
        enlargelimits=false,
        axis equal=true
        ]
...
\pie[radius=2,pos={-3,0}]{22.97 / USD,22.97/SEK,8.11/SGD,8.11/CNPY,6.76/HKD,31.07/EUR}
    
\pie[radius=2,pos={4,0},]{10/A, 20/B, 30/C, 40/D}
